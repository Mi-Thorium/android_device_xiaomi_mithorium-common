...
include $(CLEAR_VARS)
LOCAL_MODULE := generated_kernel_headers
LOCAL_EXPORT_C_INCLUDE_DEPS := $(KERNEL_HEADERS_INSTALL)
LOCAL_EXPORT_C_INCLUDE_DIRS := $(KERNEL_HEADERS_INSTALL)/include
LOCAL_EXPORT_C_INCLUDE_DIRS += $(KERNEL_HEADERS_INSTALL)/techpack/audio/include
